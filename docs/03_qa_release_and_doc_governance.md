...
本機 VM 與 fixture 測試不能取代線上服務授權、實際 Sheets API、多人編輯及 CSV 傳播驗證。2026-09-24 已核准測試副本驗收，建立私人 master / publish 副本並安裝僅指向副本的新版腳本。2026-09-25 owner 已同意新增 Sheets API v4 與其服務條款，但 Chrome 頁面控制連續逾時，代理未按下「新增」，服務狀態尚未重新確認。後續帳號授權與 preview / publish 驗收仍未完成，不能標為線上驗收通過；正式環境未更新。
