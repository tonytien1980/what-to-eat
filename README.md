...
were created and the new script installed with copy-only IDs. Sheets API v4 was added and saved on
2026-09-25 after owner approval and browser recovery. Google then blocked the read-only preview's
OAuth authorization with "This app is blocked"; live acceptance remains pending, not passed.
No publish or data write was performed. The copied master also contains 69 enabled
